...
ManifestRow = tuple[str, SideEffects, Confidentiality, Impact, bool, bool, bool, bool, bool]
...
# automatic_retry describes runtime behavior, not theoretical eligibility.
_MANIFEST_ROWS: tuple[ManifestRow, ...] = (
    ("list_accounts", "read", "financial", "none", True, False, True, True, False),
    ...
    ("list_transactions", "read", "financial", "none", True, False, True, True, False),
    ("get_transaction", "read", "financial", "none", True, False, True, True, False),
    ...
    ("list_categories", "read", "personal", "none", True, False, True, True, False),
    ("list_tags", "read", "personal", "none", True, False, True, True, False),
    ("list_currencies", "read", "public", "none", True, False, True, True, False),
    ("list_budgets", "read", "financial", "none", True, False, True, True, False),
    ...
    ("list_scheduled_transactions", "read", "financial", "none", True, False, True, True, False),
    ("get_schedule", "read", "financial", "none", True, False, True, True, False),
    ...
    ("get_pie_chart", "read", "financial", "none", True, False, True, True, False),
    ("list_wealth_points", "read", "financial", "none", True, False, True, True, False),
    ("describe_kontomierz_capabilities", "none", "public", "none", True, False, True, True, False),
)

TOOL_MANIFESTS = {row[0]: ToolManifest(*row) for row in _MANIFEST_ROWS}
